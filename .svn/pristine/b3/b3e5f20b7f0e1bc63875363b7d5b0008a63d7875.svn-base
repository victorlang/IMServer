...
public class IMConstants {
	...
	public static final String refTopicGroupIds="r";
	...
	public static final String lookupChildMsgRspEvt = "lookupChildMsgRspEvt";
	public static final String removeMsgRspEvt = "removeMsgRspEvt";
	public static final String IMNewMsgEvent = "IMNewMsgEvent";
	public static final String IMNewChildMsgEvent = "IMNewChildMsgEvent";
	...
	public static final int errTimeout =7; //有别的连接把当前连接踢掉了。
